...
contract("BoomerangRatingTests", function([deployerAddress]) {
  ...
  //
  //     const transaction = await boomerang.doSomeDebugs(userAddress, businessAddress, v, r, s);
  ...
  it("a user with the correct signature should be able to review a business", async function() {
    ...
    const transaction = await boomerang.rateBoomerangExperience(userAddress, workerAddress, businessAddress, workerRating, businessRating, ipfsHash, v, r, s);
    ...
    await boomerang.rateBoomerangExperience(userAddress, workerAddress, businessAddress, workerRating, businessRating, ipfsHash, v, r, s).should.be.rejected;
  });
});