...
const kudosRegistry = {
  ...
  update: async (businessAddress, userId, userAddress) => {
    ...
    const statusCode = await updateRegistry(businessAddress, signature, userId, userAddress);
    return statusCode;
  }
};
...
async function updateRegistry(businessAddressArg, signatureArg, userIdArg, userAddressArg) {
