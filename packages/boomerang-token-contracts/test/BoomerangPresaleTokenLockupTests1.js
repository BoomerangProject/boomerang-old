...
contract('BoomerangPresaleTokenLockupTests1', function ([_, owner, beneficiary]) {
  ...
  beforeEach(async function () {
    ...
    this.timelock = await BoomerangPresaleTokenLockup.new(this.token.address, beneficiary)
